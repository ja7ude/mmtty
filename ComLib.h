...
#define	VERID	"Ver1.80"       //K6TU   1.68A -> 1.70A Hide FlexRadio Reserved and IQ Audio Devices
#define	VERBETA	"A"             //JA7UDE 1.70A -> 1.70B G3WYW FT-991 CAT support
								...
								//JA7UDE 1.80A          modified to compile with Embarcadero C++ Builder 12 community edition
